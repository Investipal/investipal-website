...
export interface FeatureGroup {
  ...
  readonly description: string;
  readonly icon: string;
  readonly features: NavigationItem[];
}
  ...
  segments: [
    {
      ...
      description: 'Scale your practice with AI automation',
    ...
    },
    {
      id: 'wealth-firms',
      title: 'Wealth Firms',
      description: 'Enterprise-ready solutions for modern firms',
    ...
    },
    {
      ...
      description: 'Bridge planning and portfolio management',
    ...
    },
    {
      ...
      description: 'US-Canada portfolio management simplified',
  ...
  featureGroups: [
    {
      id: 'data-intake',
      title: 'Data Intake',
      description: 'Streamline client data collection and processing',
      icon: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>`,
      features: [
        {
          id: 'automated-statement-scanner',
          title: 'Automated Statement Scanner',
          description: 'Extract and process financial statements automatically',
          href: '/features/automated-statement-scanner',
          icon: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>`
        },
        {
          id: 'ai-driven-engagement',
          title: 'AI-Driven Engagement',
          description: 'Turn "Not Now" into "Tell Me More" with intelligent lead monitoring',
    ...
    },
    {
      id: 'onboarding',
      title: 'Onboarding',
      description: 'Simplify client onboarding and relationship building',
      ...
      features: [
        {
          ...
          description: 'One secure link for complete client onboarding',
        ...
        },
        {
          ...
          description: 'Generate branded proposals with AI in minutes',
    ...
    },
    {
      ...
      features: [
        {
          id: 'regulation-best-interest-generator',
          title: 'Regulation Best Interest Generator',
          description: 'Automated Reg BI compliance and documentation',
          href: '/features/regulation-best-interest-generator',
          icon: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/>`
        },
        {
          id: 'investment-policy-statements',
          title: 'Investment Policy Statements',
          description: 'Generate comprehensive IPS documents automatically',
        ...
        },
        {
          ...
          description: 'Proactive risk monitoring with AI-powered insights',
    ...
    },
    {
      id: 'portfolios',
      title: 'Portfolios',
      description: 'Core portfolio management and optimization',
      icon: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>`,
      features: [
        {
          id: 'asset-allocation',
        ...
        },
        {
          ...
          description: 'Match every dollar to a future goal',
          href: '/features/liquidity-optimization',
        ...
        {
          id: 'custom-security-builder',
          title: 'Custom Security Builder',
          description: 'Model custom securities and alternatives',
    ...
    {
      id: 'alternatives-insurance',
      title: 'Alternatives & Insurance',
      description: 'Private markets and insurance products',
      icon: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>`,
      features: [
        {
          id: 'alternatives-proposals',
          title: 'Alternatives-Driven Proposals',
          description: 'Win clients with alternatives (sales)',
          href: '/features/alternatives-proposals',
          icon: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>`
        },
        {
          id: 'alternatives-modeling',
          title: 'Alternatives Portfolio Management',
          description: 'Build portfolios with private markets',
          href: '/features/alternatives-modeling',
          icon: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>`
        },
        {
          id: 'annuities-insurance-modeling',
          title: 'Annuities & Insurance Modeling',
          description: 'FIA, IUL, and investment planning',
  ...
  resources: {
    learning: [
      ...
      },
      {
        id: 'podcasts',
        title: 'Podcasts',
        description: 'Industry conversations and insights',
        href: '/podcasts',
      ...
      },
      {
        id: 'webinars',
        title: 'Webinars',
        description: 'Educational content and product demos',
        href: '/webinars',
    ...
    company: [
      ...
      },
      {
        id: 'manifesto',
        title: 'Our Manifesto',
        description: 'Our vision for the future of wealth management',
        href: '/manifesto',
        icon: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/>`
      },
      {
