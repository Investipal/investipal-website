...
export const navigationData = {
  ...
  featureGroups: [
    ...
    },
    {
      id: 'portfolios',
      title: 'Portfolios',
      description: 'Advanced portfolio management and analysis tools',
      icon: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>`,
      features: [
        {
          id: 'custom-security-builder',
          title: 'Custom Security Builder',
          description: 'From modeling to proposal generation in just a few clicks',
          href: '/features/custom-security-builder',
          icon: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>`
        },
        {
          id: 'iul-annuity-modeling',
          title: 'IUL & Annuity Modeling',
          description: 'Advanced modeling for insurance products and retirement planning',
          href: '/features/iul-annuity-modeling',
        ...
        },
        {
          ...
          description: 'Optimize portfolio allocation with data-driven insights',
